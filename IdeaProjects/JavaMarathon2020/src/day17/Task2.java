...
public class Task2 {
    public static void main(String[] args) {
        ChessBoard board = new ChessBoard(new ChessPiece[][]{
                ...
                {ChessPiece.PAWN_BLACK, ChessPiece.EMPTY, ChessPiece.HORS_BLACK, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.PAWN_BLACK, ChessPiece.EMPTY},
